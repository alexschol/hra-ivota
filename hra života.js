...
// Nastavení plátna podle velikosti okna
function resizeCanvas() {
  canvas.width = window.innerWidth * 0.9;  // 90% šířky okna
  canvas.height = window.innerHeight * 0.8; // 80% výšky okna

  // Přepočet velikosti mřížky podle nové velikosti
  cellSize = Math.min(canvas.width, canvas.height) / 20; // Přizpůsobení mřížky
  initGrid();
}

// Přizpůsobení při načtení a změně velikosti okna
...
function changeCellSize() {
    ...
    game.className = 'game-container ' + size;
}
